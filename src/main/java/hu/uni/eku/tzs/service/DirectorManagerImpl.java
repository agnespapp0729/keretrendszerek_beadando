...
public class DirectorManagerImpl implements DirectorManager {
    ...
    public Director modify(Director director) throws DirectorNotFoundException {
        ...
        if (directorRepository.findById(director.getDirectorId()).isEmpty()) {
            throw new DirectorNotFoundException("Can not modify director with this id");
        }
    ...
    public void delete(Director director) throws DirectorNotFoundException {
        if (directorRepository.findById(director.getDirectorId()).isEmpty()) {
            throw new DirectorNotFoundException("Can not delete a director with this id");
        }
